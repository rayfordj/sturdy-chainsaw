...
build:
	...
	docker exec ${IMAGE_NAME} bash -c "tar -xzvf /foreman-katello.tgz -C / && rsync -vaP /var/lib/tftpboot/  /var/foreman-vol/var/lib/tftpboot/ && rm -rfv /var/lib/tftpboot/ && ln -vTsf /var/foreman-vol/var/lib/tftpboot /var/lib/tftpboot"
